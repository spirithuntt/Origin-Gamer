            ...
            <div class="formbg-inner padding-horizontal--48">
              ...
              <form id="stripe-login" method="POST" data-parsley-validate>
                <div class="form-group">
                  ...
                  <input type="email" class="form-control" id="email" name="email" placeholder="Enter email" data-parsley-type = "email" data-parsley-trigger="keyup" required>                </div>
                <div class="form-group">
                  <label for="InputPassword1" class="form-label mt-4">Password</label>
                  <input type="password" class="form-control" id="password" name="password" placeholder="Password" data-parsley-trigger="keyup" required>
                </div>
                <div class="form-group">
